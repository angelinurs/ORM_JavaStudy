...
public class DeptEmpVO3 {
	...
	public DeptManagerVO getDmvo() { return dmvo; }
	public void setDmvo(DeptManagerVO dmvo) { this.dmvo = dmvo; }
	
	public DeptVO getDvo() { return dvo; }
	public void setDvo(DeptVO dvo) { this.dvo = dvo; }
